...
def query_similar_documents(
    ...
    return query_similar_documents_from_text(
...
def query_similar_documents_from_text(
    text: str,
    filename: str = "",
    top_k: int = 5,
    document_ids: list[int] | None = None,
    ...
    query_text = truncate_content(filename + "\n" + text)
    ...
    return list(Document.objects.filter(pk__in=found_document_ids))
